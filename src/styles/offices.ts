export const offices = {
  fieldsWrapper:
    'flex items-center justify-center gap-[20px] max-[768px]:flex-col',
  fieldError: 'text-hoverRed text-[12px] absolute',
  select:
    'border-none text-white rounded-[6px] bg-selectBg cursor-pointer font-medium outline-none',
  displayWrapper: 'bg-grey p-[25px] rounded-[6px]',
  ...
  detailsContainer:
    'max-w-[500px] relative w-full mx-auto p-[25px] border-[2px] rounded-[4px]',
  detailsDescription:
    'text-classic text-center leading-classic font-medium mb-[5px]',
  detailsList: 'flex flex-col max-w-[200px] mx-auto',
  detailsLi: 'w-full flex justify-between mb-[3px]',
};
